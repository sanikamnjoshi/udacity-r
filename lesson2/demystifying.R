...
# Depending on the size of your window you may see different numbers
# in the output.
...
# the 32 cars. Run this next line of code to get the average mpg
